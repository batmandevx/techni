...
export const MATERIALS = [
  ...
  { 
    id: 'M2002', 
    description: 'Fruit Candy Pack 100g', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    storageLocation: 'FG01', 
    priceUSD: 1.80,
    category: 'Fruit Candy',
    leadTimeDays: 10,
    orderingCost: 45,
    holdingCostPct: 0.18,
    batchDate: '2025-11-20',
    expiryDate: '2026-11-20',
  },
  { 
    id: 'M2003', 
    description: 'Caramel Toffee 200g', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    ...
    orderingCost: 55,
    holdingCostPct: 0.22,
    batchDate: '2025-10-05',
    expiryDate: '2026-10-05',
  },
  { 
    id: 'M2004', 
    description: 'Mint Candy Jar', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    storageLocation: 'FG02', 
  ...
  { 
    id: 'M2005', 
    description: 'Assorted Candy Box', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
  ...
  { 
    id: 'M2006', 
    description: 'Coffee Candy Bag 150g', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    storageLocation: 'FG01', 
    priceUSD: 2.20,
    category: 'Coffee Candy',
    leadTimeDays: 10,
    orderingCost: 45,
    holdingCostPct: 0.18,
  ...
  { 
    id: 'M2007', 
    description: 'Jelly Beans Pack 200g', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    storageLocation: 'FG01', 
    ...
    orderingCost: 48,
    holdingCostPct: 0.19,
    batchDate: '2025-08-15',
    expiryDate: '2026-08-15',
  },
  { 
    id: 'M2008', 
    description: 'Gum Candy Box 50pcs', 
    baseUOM: 'EA', 
    salesUOM: 'EA', 
    plant: 'DXB1', 
    storageLocation: 'FG02', 
...
export const HISTORICAL_DATA: Record<string, { month: string; actualSales: number; forecast: number; openingStock: number; stockInTransit: number; safetyStock: number }[]> = {
  ...
  M2006: [
    { month: 'Oct 2025', actualSales: 2800, forecast: 2700, openingStock: 4200, stockInTransit: 400, safetyStock: 600 },
    { month: 'Nov 2025', actualSales: 3100, forecast: 2900, openingStock: 1800, stockInTransit: 2500, safetyStock: 600 },
    { month: 'Dec 2025', actualSales: 3800, forecast: 3500, openingStock: 1200, stockInTransit: 4000, safetyStock: 600 },
    { month: 'Jan 2026', actualSales: 2600, forecast: 2800, openingStock: 1400, stockInTransit: 3200, safetyStock: 600 },
    { month: 'Feb 2026', actualSales: 2700, forecast: 2800, openingStock: 2000, stockInTransit: 2800, safetyStock: 600 },
    { month: 'Mar 2026', actualSales: 0,    forecast: 3000, openingStock: 2100, stockInTransit: 3000, safetyStock: 600 },
  ],
  M2007: [
    { month: 'Oct 2025', actualSales: 1500, forecast: 1400, openingStock: 2500, stockInTransit: 300, safetyStock: 400 },
    { month: 'Nov 2025', actualSales: 1700, forecast: 1600, openingStock: 1300, stockInTransit: 1800, safetyStock: 400 },
    { month: 'Dec 2025', actualSales: 2200, forecast: 2000, openingStock: 1400, stockInTransit: 2800, safetyStock: 400 },
    { month: 'Jan 2026', actualSales: 1400, forecast: 1600, openingStock: 2000, stockInTransit: 2000, safetyStock: 400 },
    { month: 'Feb 2026', actualSales: 1500, forecast: 1600, openingStock: 2600, stockInTransit: 1800, safetyStock: 400 },
    { month: 'Mar 2026', actualSales: 0,    forecast: 1700, openingStock: 2900, stockInTransit: 2200, safetyStock: 400 },
  ],
  M2008: [
    { month: 'Oct 2025', actualSales: 900, forecast: 850, openingStock: 1800, stockInTransit: 200, safetyStock: 250 },
    { month: 'Nov 2025', actualSales: 1000, forecast: 950, openingStock: 1100, stockInTransit: 1200, safetyStock: 250 },
    { month: 'Dec 2025', actualSales: 1300, forecast: 1200, openingStock: 1300, stockInTransit: 2000, safetyStock: 250 },
    { month: 'Jan 2026', actualSales: 800, forecast: 950, openingStock: 2000, stockInTransit: 1500, safetyStock: 250 },
    { month: 'Feb 2026', actualSales: 850, forecast: 900, openingStock: 2700, stockInTransit: 1300, safetyStock: 250 },
    { month: 'Mar 2026', actualSales: 0,   forecast: 950, openingStock: 3150, stockInTransit: 1600, safetyStock: 250 },
  ],
};
