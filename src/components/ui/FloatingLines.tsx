...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (event: PointerEvent) => {
      // Use container rect so we get coordinates relative to the canvas position
      // (listening on window so events fire even when canvas is behind content layers)
    ...
    if (interactive) {
      // Listen on window so events reach canvas even when it's behind z-index layers
